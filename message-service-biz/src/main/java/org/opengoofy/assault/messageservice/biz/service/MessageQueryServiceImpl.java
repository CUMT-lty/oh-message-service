...
public class MessageQueryServiceImpl implements MessageQueryService {
    ...
    public List<MessageQueryResponseDTO> messageQuery(MessageQueryRequestDTO requestParam) {
        LambdaQueryWrapper<SendRecordDO> queryWrapper = Wrappers.lambdaQuery(SendRecordDO.class)
                ...
                .between(ObjectUtil.isAllNotEmpty(requestParam.getSendStartTime(), requestParam.getSendEndTime()), SendRecordDO::getCreateTime, requestParam.getSendStartTime(), requestParam.getSendEndTime());
